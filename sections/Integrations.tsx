...
export default function Integrations() {
  return (
    <section
      id="integrations"
      className="flex flex-col md:flex-row lg:flex-row lg:justify-between md:mx-auto md:px-[40px] lg:px-[64px] md:py-[50px] mx-[var(--spacing-20)] items-center gap-[var(--spacing-20)] p-[var(--spacing-32)] bg-[var(--colors-black-5)] dark:bg-[var(--colors-black-80)] rounded-lg md:rounded-[0px] lg:w-[85%]"
    >
      <div className="flex flex-col md:w-[80%] lg:w-[55%] gap-[var(--spacing-10)] lg:gap-[var(--spacing-12)] items-start">
        <h3 className="text-xl md:text-2xl lg:text-4xl font-bold dark:text-[var(--colors-black-0)]">
          Integrate all your key tools in Sync with your agents, workflows, and
          take actions.
        </h3>
        <p className="text-base md:text-lg lg:text-xl dark:text-[var(--colors-black-20)]">
