...
export default function Integrations() {
  return (
    <section
      id="integrations"
      className="flex flex-col md:flex-row lg:flex-row lg:justify-between md:mx-auto md:px-[40px] lg:px-[64px] md:py-[50px] mx-[var(--spacing-20)] items-center gap-[var(--spacing-20)] p-[var(--spacing-32)] bg-[var(--colors-black-5)] rounded-lg md:rounded-[0px] lg:w-[85%]"
    >
